...
//Exercise made by Valerio Corallini and Giovanni Mauro in "Pair programming" mode.
// Started at 12:10, finished at 12:24.
public class Main {
    ...
    switch (mealType){
        ...
        case "soup" :
            ...
            break;
        default:
            System.out.println("Don't included in menu");
            break;
